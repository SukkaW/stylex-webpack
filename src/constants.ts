...
export const FUCK_NEXTJS_VIRTUAL_CARRIER_PATH: string = require.resolve('./stylex.fuck-nextjs.virtual-carrier.css');
export const FUCK_NEXTJS_VIRTUAL_CARRIER_PATTERN = /stylex\.fuck-nextjs\.virtual-carrier\.css/;
