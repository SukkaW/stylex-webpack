...
interface CreateStyleXWebpackPluginOption {
  pluginName: string,
  NormalModule: typeof import('webpack').NormalModule,
...
export type StyleXWebpackPlugin = InstanceType<ReturnType<typeof createStyleXWebpackPlugin>>;
...
export const createStyleXWebpackPlugin = ({
  pluginName: PLUGIN_NAME,
  NormalModule,
  Compilation
}: CreateStyleXWebpackPluginOption) => {
  return class StyleXPlugin {
      ...
      compiler.hooks.make.tap(PLUGIN_NAME, (compilation) => {
        ...
        compilation.hooks.processAssets.tap(
          ...
          (assets) => {
            ...
            const cssFileName = paths.find(this.appendTo);
